...
public class VaultCrypto {
    ...
    public static String decryptOrders(Map<String, Object> blob, PrivateKey pk, byte[] myPubKeyDer) {
        try {
            ...
            // all peers have upgraded. Note: a KeyStore-backed privkey will
            // ALWAYS decrypt via MGF1-SHA1 due to AndroidKeyStore's internal
            // MGF1 hardcoding, so the fallback only helps software keys.
