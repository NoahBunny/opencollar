...
echo "Compiling Java..."
javac -encoding UTF-8 -source 17 -target 17 -classpath "$ANDROID_JAR$TOR_CP" -d classes src/com/focusctl/*.java

echo "Dexing..."
d8 --min-api 33 --output classes.zip classes/com/focusctl/*.class $TOR_DEX_INPUTS
